  ...
  getResultItems (keywords) {
    ...
    this.datas.forEach(({ title, content, url, tags }) => {
      ...
      slicesOfContent.forEach(slice => { 
        resultItem +=  `<p class="search-result">${this.highlightKeyword(content, slice)}...${splitTags}</p></a>`  //成功版本，tags是原始标签
        // resultItem +=  `<p class="search-result">${this.highlightKeyword(content, slice)}...<br/>${dataTags.length}</p></a>`  //测试版本
        // resultItem +=  `<p class="search-result">${this.highlightKeyword(content, slice)}...<br/>${typeof(dataTags)}</p></a>`  //测试版本

...
di _newline
"variable" _col(23) "ols estimates" _col(39) "White s.e." _col(52) 
	"s.e. corrected" _col(70) "P>|z| corrected";
di 
"--------" _col(23) "-------------" _col(39) "----------" _col(52) 
	"--------------" _col(70) "---------------";

while `z'<=`xreg'{;
	tempvar se1`z' se2`z' pvl`z';
	local beta`z'=_b[`X`z''];
	local se`z'=_se[`X`z''];
	gen `se1`z''=cov_dep[`z',`z'];
	gen `se2`z''=sqrt(`se1`z'');
	gen `pvl`z''=2*(1-norm(abs(`beta`z''/`se2`z'')));
	di "`ind`z''" _col(23)  `beta`z''  _col(39)  `se`z'' _col(52) `se2`z'' _col(70) `pvl`z'';
local z=`z'+1};
